...
public class SparseMatrix {
    ...
    public void insert(int row, int col, int value) {
        ...
        while (currentNode.next != null) {
            ...
            if (currentNode.getNext().getRow() > row
                    || (currentNode.getNext().getRow() == row && currentNode.next.getCol() > col)) {
                currentNode.next = new Node(row, col, value, currentNode.next);
                this.numElements++;
            }
            // Handles the case where the node is inserted in the middle and the location is
            // the same
        ...
        // Handles the case where the node is inserted at the tail or the head of an
        // otherwise empty matrix
        if (currentNode.next == null
                && (currentNode.getRow() <= row || (currentNode.getRow() == row && currentNode.getCol() < col))) {
            currentNode.next = new Node(row, col, value);
            this.numElements++;
        }
        // Handles the case where the node is inserted at the head of an otherwise empty
        // matrix
        else if (currentNode == this.head && currentNode.next == null
                && (currentNode.getRow() > row || (currentNode.getRow() == row && currentNode.getCol() > col))) {
        ...
        // Handles the case where the node is inserted at the tail, or the head of an
        // otherwise empty matrix and the location is the same
